...
abstract class SQLQuery 
{
	...
	protected $_boot;
	protected $_ride;
	protected $_combineFlg = false; 
	protected $_combineBlind = array(); 
	protected $_combineDescribe = array(); 
	protected $_combineUndescribe = array(); 
	protected $_belongsFlg = false;
	protected $_belongsBlind = array(); 
	protected $_belongsDescribe = array(); 
	protected $_belongsUndescribe = array(); 
	protected $_hasOneFlg = false;
	protected $_hasOneBlind = array();
	protected $_hasOneDescribe = array(); 
	protected $_hasOneUndescribe = array(); 
	protected $_hasManyFlg = false;
	protected $_hasManyBlind = array(); 
	protected $_hasManyDescribe = array(); 
	protected $_hasManyUndescribe = array(); 
	protected $_hasMABTMFlg = false;
	protected $_hasMABTMBlind = array(); 
	protected $_hasMABTMDescribe = array(); 
	protected $_hasMABTMUndescribe = array(); 
	...
	final public function BelongsBy( $value ) { return $this->_belongsBy( $value ); } 
	final public function BelongsTo( $value ) { return $this->_belongsBy( $value ); }
	final public function Bind( $value ) { return $this->_merge( $value ); } 
	final public function Combine( $value ) { return $this->_merge( $value ); } 
	...
	final public function BindSelect( $model, $field, $label = NULL ) {  } 
	final public function BindUnselect( $model, $fields ) {  } 
	final public function BindSecure( $model, $fields ) {  } 
	final public function BindUnsecure( $model, $fields ) {  } 
	final public function BindBetween( $model, $field, $start, $end ) {  } 
	final public function BindEqual( $model, $field, $value ) {  } 
	final public function BindGreater( $model, $field, $value ) {  } 
	final public function BindGreaterThanOrEqual( $model, $field, $value ) {  } 
	final public function BindIn( $model, $field, $values ) {  } 
	final public function BindIs( $model, $field, $value ) {  } 
	final public function BindIsNot( $model, $field, $value ) {  } 
	final public function BindIsNotNull( $model, $field ) {  } 
	final public function BindIsNull( $model, $field ) {  } 
	final public function BindLess( $model, $field, $value ) {  } 
	final public function BindLessThanOrEqual( $model, $field, $value ) {  } 
	final public function BindLike( $model, $field, $value ) {  } 
	final public function BindNot( $model, $field, $value ) {  } 
	final public function BindNotNull( $model, $field ) {  }
	final public function BindNotEqual( $model, $field, $value ) {  } 
	final public function BindNotIn( $model, $field, $values ) {  } 
	final public function BindNotLike( $model, $field, $value ) {  } 
	final public function BindWhere( $model, $field, $value, $operator = '=' ) {  } 
	
	final public function SelectCombine( $model, $field, $label = NULL ) {} 
	final public function UnselectCombine( $model, $fields ) {} 
	final public function SecureCombine( $model, $fields ) {} 
	final public function UnsecureCombine( $model, $fields ) {} 
	final public function BetweenCombine( $model, $field, $start, $end ) {} 
	final public function EqualCombine( $model, $field, $value ) {} 
	final public function GreaterCombine( $model, $field, $value ) {} 
	final public function GreaterThanOrEqualCombine( $model, $field, $value ) {} 
	final public function InCombine( $model, $field, $values ) {} 
	final public function IsCombine( $model, $field, $value ) {} 
	final public function IsNotCombine( $model, $field, $value ) {} 
	final public function IsNotNullCombine( $model, $field ) {} 
	final public function IsNullCombine( $model, $field ) {} 
	final public function LessCombine( $model, $field, $value ) {} 
	final public function LessThanOrEqualCombine( $model, $field, $value ) {} 
	final public function LikeCombine( $model, $field, $value ) {} 
	final public function NotCombine( $model, $field, $value ) {} 
	final public function NotNullCombine( $model, $field ) {} 
	final public function NotEqualCombine( $model, $field, $value ) {} 
	final public function NotInCombine( $model, $field, $values ) {} 
	final public function NotLikeCombine( $model, $field, $value ) {} 
	final public function WhereCombind( $model, $field, $value, $operator = '=' ) {} 
	
	final public function SelectBelongs( $model, $field, $label = NULL ) {} 
	final public function UnselectBelongs( $model, $fields ) {}
	final public function SecureBelongs( $model, $fields ) {} 
	final public function UnsecureBelongs( $model, $fields ) {} 
	final public function BetweenBelongs( $model, $field, $start, $end ) {} 
	final public function EqualBelongs( $model, $field, $value ) {} 
	final public function GreaterBelongs( $model, $field, $value ) {} 
	final public function GreaterThanOrEqualBelongs( $model, $field, $value ) {} 
	final public function InBelongs( $model, $field, $values ) {} 
	final public function IsBelongs( $model, $field, $value ) {} 
	final public function IsNotBelongs( $model, $field, $value ) {} 
	final public function IsNotNullBelongs( $model, $field ) {} 
	final public function IsNullBelongs( $model, $field ) {} 
	final public function LessBelongs( $model, $field, $value ) {} 
	final public function LessThanOrEqualBelongs( $model, $field, $value ) {} 
	final public function LikeBelongs( $model, $field, $value ) {} 
	final public function NotBelongs( $model, $field, $value ) {} 
	final public function NotNullBelongs( $model, $field ) {} 
	final public function NotEqualBelongs( $model, $field, $value ) {} 
	final public function NotInBelongs( $model, $field, $values ) {} 
	final public function NotLikeBelongs( $model, $field, $value ) {} 
	final public function WhereBelongs( $model, $field, $value, $operator = '=' ) {} 
	...
	final public function BetweenHasOne( $model, $field, $start, $end ) {} 
	final public function EqualHasOne( $model, $field, $value ) {} 
	final public function GreaterHasOne( $model, $field, $value ) {} 
	final public function GreaterThanOrEqualHasOne( $model, $field, $value ) {} 
	final public function InHasOne( $model, $field, $values ) {} 
	final public function IsHasOne( $model, $field, $value ) {} 
	final public function IsNotHasOne( $model, $field, $value ) {} 
	final public function IsNotNullHasOne( $model, $field ) {} 
	final public function IsNullHasOne( $model, $field ) {} 
	final public function LessHasOne( $model, $field, $value ) {} 
	final public function LessThanOrEqualHasOne( $model, $field, $value ) {} 
	final public function LikeHasOne( $model, $field, $value ) {} 
	final public function NotHasOne( $model, $field, $value ) {} 
	final public function NotNullHasOne( $model, $field ) {} 
	final public function NotEqualHasOne( $model, $field, $value ) {} 
	final public function NotInHasOne( $model, $field, $values ) {} 
	final public function NotLikeHasOne( $model, $field, $value ) {} 
	final public function WhereHasOne( $model, $field, $value, $operator = '=' ) {} 
	...
	final public function BetweenHO( $model, $field, $start, $end ) {} 
	final public function EqualHO( $model, $field, $value ) {} 
	final public function GreaterHO( $model, $field, $value ) {} 
	final public function GreaterThanOrEqualHO( $model, $field, $value ) {} 
	final public function InHO( $model, $field, $values ) {} 
	final public function IsHO( $model, $field, $value ) {} 
	final public function IsNotHO( $model, $field, $value ) {} 
	final public function IsNotNullHO( $model, $field ) {} 
	final public function IsNullHO( $model, $field ) {} 
	final public function LessHO( $model, $field, $value ) {} 
	final public function LessThanOrEqualHO( $model, $field, $value ) {} 
	final public function LikeHO( $model, $field, $value ) {} 
	final public function NotHO( $model, $field, $value ) {} 
	final public function NotNullHO( $model, $field ) {} 
	final public function NotEqualHO( $model, $field, $value ) {} 
	final public function NotInHO( $model, $field, $values ) {} 
	final public function NotLikeHO( $model, $field, $value ) {} 
	final public function WhereHO( $model, $field, $value, $operator = '=' ) {} 
	...
	private function _unblind( $fields ) 
	{
		foreach( $fields as $key => $field ) 
			if(in_array($field, $this->_undescribe)) 
				unset($this->_undescribe[$key]);
		return $this;
	}
	...
	private function _unselect( $fields ) 
	{
		...
		$this->_undescribe = array_merge( $this->_undescribe, (array) $fields ); 
		return $this;
	}
	
	private function _getCollectionString() 
	{
		if( is_null($this->_collection) && !empty($this->_undescribe) )
		{
			...
			// $describe = $this->_describe; 
				...
				// {
					// if( in_array( $value, $this->_undescribe ) ) 
					// {
						// unset( $describe[ $key ] );
						// $hasChange = true;
					// } 
		...
		if( $this->_hasOneFlg ) 
		{
			foreach( $this->_hasOne as $model => $event) 
			{
				if(in_array($model, $this->_hasOneBlind)) 
					continue; 
				foreach( $event['describe'] as $column ) 
				{
					$field = $column['field'][0];
					$this->_collection .= ",`$model`.`$field`";
				}
			}
		}
	...
	{
		if( isset($this->_hasManyAndBelongsToMany) && $this->_hasMABTMFlg ) 
		{
				...
				if( is_array($this->_hasManyAndBelongsToMany[ $model ]) ) 
				{
					...
					else if( is_array($field) ) 
					{
						foreach($field as $field_key => $field_value) 
						{
							...
							{
								$this->_select_hMABTM( $model, $field_value, NULL );
							} 
							else if( is_string($field_key) ) 
							{ 
								$this->_select_hMABTM( $model, $field_key, $field_value ); 
							}
						} 
					}
				}
	...
	{
		if( isset($this->_hasOne) && $this->_hasOneFlg ) 
		{
				...
				if( is_array($this->_hasOne[ $model ]) ) 
				{
					...
					else if( is_array($field) ) 
					{
						foreach($field as $field_key => $field_value) 
						{
							if(is_numeric($field_key)) 
							{
								$this->_select_HasOne( $model, $field_value, NULL );
							} 
							else if( is_string($field_key) ) 
							{ 
								$this->_select_HasOne( $model, $field_key, $field_value ); 
							}
						} 
					}
				}
	...
	{
		if( isset($this->_hasMany) && $this->_hasManyFlg ) 
		{
				...
				if( is_array($this->_hasMany[ $model ]) ) 
				{
					...
					else if( is_array($field) ) 
					{
						foreach($field as $field_key => $field_value) 
						{
							if(is_numeric($field_key)) 
							{
								$this->_select_HasMany( $model, $field_value, NULL );
							} 
							else if( is_string($field_key) ) 
							{ 
								$this->_select_HasMany( $model, $field_key, $field_value ); 
							}
						} 
					}
				}
	 ...
	 * $this->model->merge([
	 *	'Avatar' 	=> array(
	 *		'media.avatar_id.id', 			// merged_alias . foreign_key . merged_table_key
	 ...
	 *	), 
	 *	'UserStat' 	=> array(
	 *		'user_stat.id.item_id'			// merged_alias . foreign_key . merged_table_key
	 *	),
	 * ]);
	 *
	 ...
	 */
	private function _merge( $models, $belongBy=false )
	{
		global $inflect;
		$prefix = $this->_retrivePrefix();
		$this->_imerge = EMPTY_CHAR;
		$mergeType = ($belongBy) ? "RIGHT JOIN" : "INNER JOIN";
		...
		if( is_string($models) ) 
		{
			if( isset($this->_hasOne[ $models ]) )
			{
				...
				$this->_imerge .= $mergeType." `".$tableChild."` AS `".$modelChild."` ON `".$modelChild."`.`id` = `".$this->_model."`.`".$aliasKey."` ";
			}
		} 
		else 
		{
			foreach( $models as $alias => $model ) 
			{
				...
				$this->_imerge .= $mergeType." `".$table_merge."` AS `".$alias."` ON `".$alias."`.`".$alias_key."` = `".$this->_model."`.`".$foreign_key."` ";
			}
		}
		return $this;
	} 
	
	private function _belongsBy( $models ) 
	{
		return $this->_merge( $models, true ); 
	}
	...
	private function _buildMainQuery( $prefix ) 
	{
		...
		if( $this->_hasOneFlg && isset( $this->_hasOne ) ) 
		{
	...
	private function _search() 
	{
		...
		if( $this->_result ) 
		{
			...
			if( $rsNumRows > 0 ) 
			{
				...
				{
					$ignoreField = false;
					foreach( $this->_undescribe as $i => $columnName ) 
					{
						...
						{
							if( $field_info->name === $columnName && $field_info->table == $this->_model ) 
							{
								$ignoreField = true;
							}
						}
				...
				while( $row = mysqli_fetch_row( $this->_result ) ) 
				{
							...
							if( isset($this->_hasOne[ $table[ $i ] ]) ) 
							{
								if( isset($this->_hasOne[ $table[ $i ] ][ 'undescribe' ]) )
									if( in_array( $field[ $i ], $this->_hasOne[ $table[ $i ] ][ 'undescribe' ] ) ) 
										continue; 
								if( isset($this->_hasOne[ $table[ $i ] ][ 'describe' ]) ) 
								{
									foreach($this->_hasOne[ $table[ $i ] ][ 'describe' ] as $hasOneField) 
									{
										$hOField = $field[ $i ];
										if($hOField===$hasOneField['field'][0]) 
										{
											if( isset($hasOneField['label'] ) )
												$hOField = $hasOneField['label'][$hOField]; 
											$tempResults[ $table[ $i ] ][ $hOField ] = $row[ $i ];
											break;
										} 
									}
									continue; 
					...
					if( $this->_hasManyFlg && isset( $this->_hasMany ) ) 
					{
					...
					if ($this->_hasMABTMFlg && isset($this->_hasManyAndBelongsToMany)) 
					{
		...
		if( $this->id != NULL && $rsNumRows === 1 ) 
		{
			...
			if( $this->_hasOneFlg || $this->_hasManyFlg || $this->_hasMABTMFlg ) 
				return $result[0]; 
			else 
	...
	private function _clear( $deep=false ) 
	{
		...
		$this->_combineFlg = false; 
		$this->_belongsFlg = false; 
		$this->_hasOneFlg = false;
		$this->_hasManyFlg = false;
		$this->_hasMABTMFlg = false;
		$this->_page = NULL;
		$this->_imerge = NULL;
		$this->_undescribe = array();
	...
	{
		if( $this->setTable() == MODEL_SFREE && _useDB() ) 
			$this->_alias = $value;
		return $this;
	}
